...
var stripe = Stripe('pk_test_51NFwotSIH8fieRDzRkcDSuUbZTeeCxLIqZWZj6Ip09OND3bfRMlU8VkLdByiAIb8r0TKrN1eFtj0H82CS7osf6gV004ZTnI2R6');
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          _context.next = 8;
          return session.data.session.url;

        case 8:
          stripeUrl = _context.sent;
...
if (signupForm) signupForm.addEventListener('submit',
/*#__PURE__*/
function () {
  var _ref = _asyncToGenerator(
  /*#__PURE__*/
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "1579" + '/');
